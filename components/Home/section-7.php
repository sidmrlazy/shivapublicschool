    ...
    <div class="container">
        ...
        <div class="section-7-row">
            ...
            <form action="" method="POST" class="col-md-6 section-7-form">
                ...
                <div class="form-floating mb-3">
                    <input type="email" class="form-control" name="contact_email" id="contactEmail" placeholder="abc@xyz.com">
                    <label for="contactEmail">E-Mail</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" name="contact_number" id="contactNumber" placeholder="+919876543210">
                    <label for="contactNumber">Contact number</label>
                </div>

                <div class="form-floating mb-3">
                    <textarea class="form-control" name="contact_details" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
            ...
            <div class="col-md-6 section-7-lottie">
                <lottie-player src="https://assets6.lottiefiles.com/packages/lf20_7wwm6az7.json" background="transparent" speed="1" loop autoplay></lottie-player>
            </div>
        </div>
    </div>
</div>